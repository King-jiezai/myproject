...
<style scoped>
    ...
    .refund-amount p:first-child {
        float: left;
        color: #999;
    }
    .refund-amount p:last-child {
        float: left;
        color: #0A8CCA;
        margin-left: 100px;
    }
        ...
        <div class="only-cent">
            ...
            <div class="only-left">
                ...
                <div class="left-top">
                    ...
                    <div class="success">
                        <p>退款成功时间：{{data}}<span>{{times}}</span></p>
                    </div>
                </div>
                ...
                <div class="left-consult">
                    ...
                    <!--left-history 协商的数据-->
                    <div class="left-history" v-for="item in seller">
                        ...
                        <div class="history-cent">
                            <p>{{ item.fon }}{{item.loo}}{{ item.mon }}</p>
                        </div>
                    </div>
            ...
            <div class="only-right">
                ...
                <div class="right-bottom">
                    ...
                    <div class="bottom">
                        <p>货物状态：</p>
                        <p class="deposits">{{ this.states }}</p>
                    </div>
        ...
        data () {
            ...
            return {
                ...
                seller  : [{
                    ...
                    naimg : '../../../../static/images/refund/777.jpg',
