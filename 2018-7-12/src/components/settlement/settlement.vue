        ...
        <div class="sett-bottom">
            <div class="fsl">
                ...
                <div class="qb">
                    ...
                    <div class="poo">
                        <div class="poo-oo">
                            <img src="../../../static/images/sett/rec-2.png">
                            <p class="ps">二手笔记本电脑 联想Thinkpad X220 X230 12寸ibm超薄手提上网本</p>
                        </div>
                        ...
                        <div class="poo-oo">
                            <p class="oo-one">租金小计：￥119.0</p>
                            <p class="oo-one">总押金：￥2000</p>
                        </div>
                    </div>

                    <div class="mos">
                        <span class="os">次新设备</span>
                        <span class="os">即租即还</span>

                        <div class="qso">
                            <span>租赁方式：</span>
                            <div class="og">月租金：￥119.0，租期12个月</div>
                        </div>
                        ...
                        <div class="qsos">租赁方案：全额押金+月付</div>
                    </div>
                    ...
                    <div class="personal">
                        ...
                        <div class="fso">
                            <div class="box-box">
                                <div class="fso-box">
                                    <RadioGroup v-model="vertical" vertical @on-change='lis'>
                                        <Radio :label="item.name" v-for='(item, index) in res' :key='index'>
                                            ...
                                            <span class="boo" @click='oo(index)'>
                                                <span class="fsl-o">{{item.fon}}（{{item.nams}}<span class="shou">收</span>）</span>
                                                <span class="fsl-t">{{item.num}}</span>
