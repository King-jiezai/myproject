        ...
        <div class="news-bottom">
            ...
            <div class="fsl-bos">
                ...
                <div class="phones">
                    ...
                    <input type="text" class="inb" placeholder="区号">
                    <span>-</span>
                    <input type="text" class="inc" placeholder="电话号码">
                </div>
            </div>
    ...
    export default {
        ...
        watch : {
            ...
            reo () {
                ...
                this.arr = this.$store.state.reo

                this.tea   = this.arr.arr[this.$store.state.reo.num].fon
                this.name  = this.arr.arr[this.$store.state.reo.num].nams
                this.phone = this.arr.arr[this.$store.state.reo.num].num
                this.office= this.arr.arr[this.$store.state.reo.num].off
        ...
        methods : {
            ...
            pret () {
                ...
                if (this.tea != '') {
                    this.arr.arr[this.$store.state.reo.num].fon  = this.tea
                }

                if (this.name != '') {
                    this.arr.arr[this.$store.state.reo.num].nams = this.name
                }

                if (this.phone != '') {
                    this.arr.arr[this.$store.state.reo.num].num  = this.phone
                }

                if (this.office != '') {
                    this.arr.arr[this.$store.state.reo.num].off  = this.office
                }
