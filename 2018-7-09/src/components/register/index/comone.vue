...
<template>
    ...
    <div class="regs">
        ...
        <div class="mos-left">
            ...
            <div v-show='code'>
                <div class="code">
                    <p><span class="xin">*</span>校验码</p>
                    <input type="text" v-model='coo' @blur='xym'>
                    <span class="so">dsfsfg</span>

                    <div class="fff-right" v-show='cos'>
                        <img src="../../../../static/images/reg/sj2.png">
                        <div class="right-right">
                            <div class="x">x</div>
                            <span>请输入验证码</span>
                    ...
                    <div class="fff-right" v-show='coso'>
                        <img src="../../../../static/images/reg/sj2.png">
                        <div class="right-right">
                            <div class="x">x</div>
            ...
            <div class="customer">
                ...
                <span class="wu">若无联系过广租客户经理请选择“无”</span>
            </div>
    ...
    export default {
        ...
        methods : {
            ...
            xym () {
                ...
                if (patrn.test(this.coo) && this.coo.length == 4) {
