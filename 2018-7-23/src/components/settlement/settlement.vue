            ...
            <div class="fsl">
                ...
                <div class="qb">
                    ...
                    <div class="infor">
                        ...
                        <div class="infor-cont">
                            <div class="infor-left">
                                <div class="infor-logis">                  
                                    <p>在线支付</p>
                                    <img src="../../../static/images/sett/4.png">
                                </div>
                                
                                <div class="distri-time">
                                    <p>配送时间：</p>
                                    <div class="radiogroup">
                                         <RadioGroup v-model="animal">
                                            <Radio label="工作日送"></Radio>
                                            <Radio label="双休日/假日送"></Radio>
                                            <Radio label="工作日、双休日与假日送"></Radio>
                                        </RadioGroup>
                                    </div>
                            ...
                            <div class="infor-right">
                                <div class="infor-right-cont" v-for='item in shop'>
                                    <div class="infor-img">
                                        <img :src="item.imgs">
                                    </div>
                                    <div class="infor-text">
                                        <p class="shops">{{item.fon}}</p>
                                        <div class="infor-money">
                                            <p class="money"><span>￥{{mon}}</span></p>                                           
                                            <div class="loss">
                                        ...
                                        <div class="infor-term">
                                            <p class="term">租期：<span>{{item.lease}}</span>个月</p>
                                            <p>租金方案：全额押金+月付</p>
                                        </div>
                                    </div>
                                     <div class="poo-oo">
                    ...
                    <div class="mess">
                        <div class="mess-oo">
                            <p class="ls">我的留言：</p>
                            <textarea class="wl" placeholder="选填，少于200字。提醒：如果备注信息和订单内容有冲突，除非您已和客服确定，否则以订单内容为准"></textarea>
                        </div>
                    ...
                    <div class="personal">
                        ...
                        <div class="fso">
                            <div class="box-box">
                                <div class="fso-box">
                                    <RadioGroup vertical @on-change='lis'>
                                        <Radio :label="item.num" v-for='(item, index) in res' :key='index'>
                                            ...
                                            <span class="boo" @click='oo(index)'>
                                                ...
                                                <span class="fsl-t">{{item.receiverPhone}}</span>
                    ...
                    <div class="coupon">
                        ...
                        <div class="cen-cen">
                            ...
                            <div class="kos">
                                <p class="pp1">商品总压金：￥189.00</p>

                                <p class="pp2">
                                    <span>减免押金：-￥10.00</span>
                                    <span>应付租金：￥99</span>
                                    <span>增值服务：￥50</span>
                                </p>
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                shop : [{
                    imgs : '../../../static/images/sett/rec-2.png',
                    fon  : '联想Thinkpad X220 X230 12寸ibm超薄手提上网本',
                    lease: 3, 
                }] ,
