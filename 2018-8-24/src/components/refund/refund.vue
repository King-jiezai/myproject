        ...
        <div class="refund-cnet">
            ...
            <div class="refund-type">
                ...
                <div class="radiogroup">
                    <RadioGroup v-model="enterprise" @on-change="change" size='large'>
                        <Radio label="仅退款" v-show="lab" size='large'></Radio>
                        <Radio label="退货退款" v-show="labs" size='large'></Radio>
                        <Radio label="仅换货" v-show="bars" size='large'></Radio>
                    </RadioGroup>
                </div>
            </div>
        ...
        methods : {
            ...
            change () {
                ...
                if (this.enterprise == '仅退款') {
                    ...
                    this.$router.push('/refund?orderNo=' + this.$route.query.orderNo + '&productId=' + this.$route.query.productId + '&num=' + 1)
                    ...
                    this.$router.push('/refund?orderNo=' + this.$route.query.orderNo + '&productId=' + this.$route.query.productId + '&num=' + 2)
                    ...
                    this.$router.push('/refund?orderNo=' + this.$route.query.orderNo + '&productId=' + this.$route.query.productId + '&num=' + 3)
