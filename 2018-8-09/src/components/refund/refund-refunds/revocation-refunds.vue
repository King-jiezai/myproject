        ...
        <div class="only-cent">
            ...
            <div class="only-left">
                ...
                <div class="left-top">
                    <div class="agree">
                        <p>退款关闭</p>
                        <p>退款关闭时间：{{date}}<span>{{times}}</span></p>
                        <p>因您撤销退款申请，退款已关闭</p>
                    </div>
                </div>
                ...
                <div class="left-consult">
                    ...
                    <div class="left-history" v-for="item in his">
                        ...
                        <p>{{ item.fon }}</p>
                        <div class="history-cent" v-for="item in item.res">
                            <p>买家({{item.names}})于{{ item.dates }}<span>{{ item.tim }}</span>创建了退款申请</p>
