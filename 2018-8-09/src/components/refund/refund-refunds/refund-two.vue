...
<template>
    ...
    <div class="only-refunds">
        ...
        <div class="only-cent">
            ...
            <div class="only-left">
                ...
                <div class="left-cent">
                    <div class="cent-success">
                        <p>1.商家同意后，请按照给出的退货地址退货，并请记录退货运单号</p>
                        <p>2.如商家拒接，您可以修改申请后再次发起，商家会重新处理</p>
                        <p>3.如商家超时未处理，退货申请将达成，请按系统给出的退货地址退货</p>
                    </div>
                ...
                <div class="left-consult">
                    ...
                    <!--left-history 协商的数据-->
                    <div class="left-history" v-for="item in his">
                        ...
                        <div class="history-cent">
                            <p>买家({{item.names}})于{{ item.datas }}<span>{{ item.time }}</span>创建了退款申请</p>
            ...
            <!--only-right 右边订单详情-->
            <div class="only-right" v-for="item in seller">
                ...
                <div class="deposit">
                    <p><span>押</span>金：</p>
                    <p class="deposits">￥：{{ item.deposits }}<span>x{{ item.num }}(数量)</span></p>
                </div>

                <!--deposit 租金-->
                <div class="deposit">
                    <p><span>租</span>金：</p>
                    <p class="deposits">￥：{{ item.rent }}</p>
                </div>

                <!--deposit 优惠-->
                <div class="deposit">
                    <p><span>优</span>惠：</p>
                    <p class="deposits">￥：{{ item.discount }}</p>
                </div>

                <!--deposit 邮费-->
                <div class="deposit">
                    <p><span>邮</span>费：</p>
                    <p class="deposits">￥：{{ item.postage }}</p>
                </div>
                ...
                <!--logistics 物流信息-->
                <div class="logistics" @click="clilogi">
                    <p>物流信息</p>
                </div>
                ...
                <div class="right-bottom">
                    ...
                    <div class="bottom">
                        <p>退款金额：</p>
                        <p class="deposits">￥：{{ item.loo }}</p>
                    </div>

                    <!--bottom 原因-->
                    <div class="bottom">
                        <p><span>原</span>因：</p>
                        <p class="deposits">{{ item.cause }}</p>
                    </div>

                    <!--bottom 要求-->
                    <div class="bottom">
                        <p><span>要</span>求：</p>
                        <p class="deposits">{{ item.enterprise }}</p>
                    </div>

                    <!--bottom 货物状态-->
                    <div class="bottom">
                        <p>货物状态：</p>
                        <p class="deposits">{{ item.state }}</p>
                    </div>
        ...
        data () {
            ...
            return {
                ...
                his : [{
                    ...
                    datas : this.$store.state.len,

                    time : '13:50:00',

                    state: '未发货',

                    naimg : '../../../../static/images/refund/11.png',

                    enterprise :this.$store.state.poo,

                    cause : this.$store.state.reo,

                    loo : this.$store.state.val,
