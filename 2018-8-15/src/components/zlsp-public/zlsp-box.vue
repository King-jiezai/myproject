    ...
    export default {
        ...
        methods : {
            ...
            contrast (index, key) {
                ...
                //点击当前对比图标显示对比栏
                if (this.oop[index].reo[key] == this.oop[index].reo[0]) {
                    this.ooc = true
                }

                //对比栏如果存在当前数据，显示提示
                if (this.oop[index].reo[key] == this.oop[index].reo[0] && this.pos.includes(this.oop[index])) {
                ...
                //
                if (this.oop[index].reo[key] == this.oop[index].reo[0] && this.pos.length < 4) {
                ...
                if (this.oop[index].reo[key] == this.oop[index].reo[0] && this.pos.indexOf(this.oop[index]) < 0) {
