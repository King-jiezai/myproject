    ...
    <div class="body">
        ...
        <div class="logisticss" @click="close" v-show="logis">
            ...
            <div class="logistics-cent">
                ...
                <!--refunds-efundment 退货说明-->
                <div class="refunds-efundment">
                    <p class="modify-pss"><span class="sp1">*</span>退货说明：</p>
                    <textarea v-model="value6" placeholder="退货说明"></textarea>
                </div>

                <!--refunds-upimg 上传图片-->
                <div class="refunds-upimg">
                    <p class="modify-pss"><span class="sp1">*</span>上传图片：</p>
                    <div class="upimg">
                        <zupImg></zupImg>
                    </div>
                </div>
