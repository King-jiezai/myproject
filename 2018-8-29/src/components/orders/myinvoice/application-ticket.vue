        ...
        <div class="invoice_cont">
            ...
            <div class="invoice_type">
               ...
               <div class="radiogroup" >
                     <RadioGroup v-model="animal" @on-change="changeall" size='large'>
                        <Radio label="增值税普通发票" size='large'></Radio>
                        <Radio label="增值税专用发票" size='large'></Radio>
                    </RadioGroup>
                </div>
            </div>
                ...
                <div class="unit_type">
                    ...
                    <div class="radiogroup">
                         <RadioGroup v-model="enterprise" @on-change="change" size='large'>
                            <Radio label="企业" size='large'></Radio>
                            <Radio label="个人" size='large'></Radio>
                        </RadioGroup>
                    </div>
                </div>
...
<script>
    ...
    import personalInvoice from '@/components/orders/myinvoice/personal-invoice.vue'
    import specialInvoice  from '@/components/orders/myinvoice/special-invoice.vue'
