...
<script>
    ...
    export default {
        ...
        created () {
            ...
            //获取打开新窗口的id
            this.dao = this.$route.query.pid

            //根据页面所传的id打开我的租赁页面
            if (this.dao == this.res[0].reo[0].id) {

                this.orders = true

                if (this.active_id = this.dao) {
             ...
             //根据页面所传的id打开我的账户页面
            if (this.dao == this.res[4].reo[0].id) {
             ...
             //根据页面所传的id打开个人信息页面
            if (this.dao == this.res[7].reo[0].id) {
             ...
             //根据页面所传的id打开账户安全页面
            if (this.dao == this.res[7].reo[1].id) {
             ...
             //根据页面所传的id打开售后地址管理页面
            if (this.dao == this.res[7].reo[2].id) {
