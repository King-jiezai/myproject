    ...
    <div class="news">
        ...
        <div class="news-bottom">
            ...
            <div class="fsl-bos">
                ...
                <span>设为默认收货地址</span>
                <div class="pre" @click="pret">保存</div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        watch : {
            ...
            reo () {
                ...
                let arr = this.$store.state.reo

                let obs = arr.data.data.receiverArea.split('-')
                        
                this.pos = obs[0]
                this.city = obs[1]
                this.area = obs[2]
                this.guo = arr.data.data.receiverRegion
                this.tea = arr.data.data.receiverAddress
                this.office = arr.data.data.receiverZip
                this.name = arr.data.data.receiverName
                this.phone = arr.data.data.receiverPhone

                let o = arr.data.data.receiverMobile.split('-')
        ...
        methods : {
            ...
            async pret () {
                ...
                if (!blur.test(this.phone) && this.phone != '') {
                    ...
                    if (this.guo != '') {
                        arr.data.data.receiverRegion = this.guo
                    }
                    if (this.pos != '') {
                        obs[0] = this.pos
                    }
                    ...
                    if (this.tea != '') {
                        arr.data.data.receiverAddress = this.tea
                    }
                    if (this.office != '') {
                        arr.data.data.receiverZip = this.office
                    }
                    if (this.name != '') {
                        arr.data.data.receiverName = this.name
                    }
                    if (this.phone != '') {
                        arr.data.data.receiverPhone = this.phone
                    }
                    if (this.qu != '') {
                        o[0] = this.qu
                    }
                    ...
                    this.listShipping = await this.$api.updateShipping({
                        id : this.$store.state.reo.data.data.id,
                        receiverName : arr.data.data.receiverName,
                        receiverPhone : arr.data.data.receiverPhone,
                        receiverMobile : posi.join('-'),
                        receiverRegion : arr.data.data.receiverRegion,
                        receiverArea : poss.join('-'),
                        receiverAddress : arr.data.data.receiverAddress,
                        receiverZip : arr.data.data.receiverZip
                    })
